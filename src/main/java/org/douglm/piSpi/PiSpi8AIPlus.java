...
public class PiSpi8AIPlus extends SpiDevice {
  ...
  public PiSpi8AIChannelConfig getChannelConfig(final int channel) {
   ...
   */
  private int readChannel(final PiSpi8AIChannelConfig chanConf) throws ProviderException {
  ...
  public double rToDegCWithSh(final PiSpi8AIChannelConfig chanConf,
                              final int value) {
  ...
  public double countToResistance(final PiSpi8AIChannelConfig chanConf,
                                  final int value) {
   ...
   */
  public double rToDegC(final PiSpi8AIChannelConfig chanConf,
                        final int value) {
   ...
   * @return degrees centigrade
   */
  public double rToDegCWithBeta(final PiSpi8AIChannelConfig chanConf,
                                final int value) {
